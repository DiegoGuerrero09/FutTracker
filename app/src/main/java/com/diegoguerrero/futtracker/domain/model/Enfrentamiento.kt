...
data class EstadisticasJugadorCruzadas(
    ...
    val golesDiestraComoCompaneroInd: Int = 0,
    val golesZurdaComoCompaneroInd: Int = 0,
    val golesCabezaComoCompaneroInd: Int = 0,
    val golesOtroComoCompaneroInd: Int = 0,
    ...
    val golesDiestraComoRivalInd: Int = 0,
    val golesZurdaComoRivalInd: Int = 0,
    val golesCabezaComoRivalInd: Int = 0,
    val golesOtroComoRivalInd: Int = 0,
    ...
    val golesDiestraTarget: Int = 0,
    val golesZurdaTarget: Int = 0,
    val golesCabezaTarget: Int = 0,
    val golesOtroTarget: Int = 0,
    ...
    val golesDiestraTargetComoCompaneroInd: Int = 0,
    val golesZurdaTargetComoCompaneroInd: Int = 0,
    val golesCabezaTargetComoCompaneroInd: Int = 0,
    val golesOtroTargetComoCompaneroInd: Int = 0,
    ...
    val golesDiestraTargetComoRivalInd: Int = 0,
    val golesZurdaTargetComoRivalInd: Int = 0,
    val golesCabezaTargetComoRivalInd: Int = 0,
    val golesOtroTargetComoRivalInd: Int = 0,
