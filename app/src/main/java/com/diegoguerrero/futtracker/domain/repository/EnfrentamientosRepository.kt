...
interface EnfrentamientosRepository {
    fun obtenerHistorialCruzado(fechaInicio: Long? = null, fechaFin: Long? = null): Flow<List<EstadisticasJugadorCruzadas>>
    fun obtenerDestacados(fechaInicio: Long? = null, fechaFin: Long? = null): Flow<DestacadosEnfrentamientos>
    fun obtenerHistorialCruzadoParaJugador(jugadorId: String, fechaInicio: Long? = null, fechaFin: Long? = null): Flow<List<EstadisticasJugadorCruzadas>>
    fun obtenerDestacadosParaJugador(jugadorId: String, fechaInicio: Long? = null, fechaFin: Long? = null): Flow<DestacadosEnfrentamientos>
